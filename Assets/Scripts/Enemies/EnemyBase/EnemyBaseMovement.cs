...
public class EnemyBaseMovement : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            Debug.LogWarning("Patrol boundaries are not set. Assign left and right boundary Transforms.");
        }
    }
    ...
    public void HandleMovement()
    {
        ...
        {
            isChasing = true;
            Debug.Log("Player detected! Switching to chase mode.");
        }
        else
        {
            isChasing = false;
            Debug.Log("Player out of range. Switching back to patrol.");
        }
